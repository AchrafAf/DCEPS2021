...
def set_notes():
    ...
    st.markdown('### Notes dominantes')
    st.markdown("Dans cette partie, on cherche la répartition des notes musicales dominantes dans les fichiers audio selon la présence ou l'absence des chants d'oiseaux.")
